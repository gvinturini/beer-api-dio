...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Giovanni Vinturini";
    private static final String CONTACT_GITHUB = "https://github.com/gvinturini";
    private static final String CONTACT_EMAIL = "go_vinturini@hotmail.com";
